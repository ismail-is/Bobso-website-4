                        ...
                        <div className="section-head">
                            <div className="mt-separator-outer separator-left" style={{display:'flex',justifyContent:'center'}}>
                                <div className="mt-separator" >
                                    <h2 className="text-uppercase sep-line-one " style={{color:''}}><span className="font-weight-300 text-primary">Safety </span> Policy</h2>
                                </div>
                            </div>
                        </div>
                            <div className="project-detail-outer">
                                ...
                                <div className="project-detail-containt">
                                    <div className="bg-white text-black">
                                        <h4 className="font-weight-600">BOBSCO.</h4>
